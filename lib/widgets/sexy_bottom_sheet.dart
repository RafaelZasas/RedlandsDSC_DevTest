...
void toggleBottomSheet() => controller.fling(velocity: isBottomSheetOpen ? -2 : 2);
...
class _SexyBottomSheetState extends State<SexyBottomSheet> with SingleTickerProviderStateMixin {
  double get maxHeight => MediaQuery.of(context).size.height;

  double get headerTopMargin => lerp(16, 0 + MediaQuery.of(context).padding.top);
...
class ExpandedSheetItem extends StatelessWidget {
  ...
  const ExpandedSheetItem(
      {Key key, this.topMargin, this.height, this.isVisible, this.borderRadius, this.title, this.leftMargin})
      : super(key: key);
          ...
          child: Row(
            ...
            children: <Widget>[
              Padding(
                ...
                child: Text(
                  'Press & hold me',
                  style: isThemeCurrentlyDark(context) ? SubHeadingStylesMaterial.light : SubHeadingStylesMaterial.dark,
                ),
              ),
            ],
          ),
